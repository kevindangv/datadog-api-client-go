...
type MonitorOptions struct {
        ...
        SyntheticsCheckId string                  `json:"synthetics_check_id,omitempty"`
...
func (o *MonitorOptions) GetSyntheticsCheckId() int64 {
        if o == nil || o.SyntheticsCheckId == "" {
                var ret int64
                return ret
        }
        var idInt int64
        idInt, _ = strconv.ParseInt(o.SyntheticsCheckId,10,64)
        return idInt
}
...
func (o *MonitorOptions) SetSyntheticsCheckId(v int64) {
        o.SyntheticsCheckId = strconv.FormatInt(v, 10)
}
